...
const platforms = [
  { name: 'Apple Podcasts', image: '/images/Apple.webp', href: '#' },
  { name: 'Spotify', image: '/images/Spotify.webp', href: '#' },
  { name: 'YouTube Music', image: '/images/YT-Music.webp', href: '#' },
  { name: 'YouTube', image: '/images/YouTube.webp', href: '#' },
];

export default function LetsTalkFacilitiesContent() {
  ...
  return (
    <RedesignLayout>
      <PageHero
        ...
        backgroundImage="/images/Premrest_LTF_Hero_Blob.webp"
      />
        ...
        >
          ...
          >
            <img
              ...
              alt="Let's Talk Facilities podcast logo"
              style={{
                width: '240px',
                height: 'auto',
          ...
          >
            <Heading as="h2" size="heading-lg">
              {"The podcast for facilities professionals"}
            </Heading>
            <p
              style={{
            ...
            >
              Join us as we dive into the world of facilities management, exploring industry trends, expert insights, and real-world stories from the people keeping Australia&apos;s commercial spaces in top shape.
            </p>
      ...
      <CTABanner
        ...
        description="Subscribe to Let's Talk Facilities on your favourite platform."
