            ...
            <div class="grid-wrapper">
              <div class="grid-1-column">
                <div class="grid-column w-richtext">
                  ...
                  <p>For enquiries related to these Terms, please contact us <a href="contact.html" class="link-2">here</a>.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="grid-4-columns">
                ...
                <div class="grid-column grid-column-footer grid-column-top">
                  ...
                  <ul role="list" class="footer-list w-list-unstyled">
                    ...
                    <li>
                      <a href="terms-of-service.html" aria-current="page" class="footer-list-link w-inline-block w--current">
