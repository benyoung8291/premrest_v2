          ...
          <div class="nav_container">
            <div class="nav_offcanvas_menu">
              <div class="nav_menu_block is-cream">
                <div class="nav_menu_links_wrapper">
                  ...
                  <a href="/resources" aria-current="page" class="nav_menu_links w-inline-block w--current">
            ...
            <div class="nav_block flex-right">
              <nav role="navigation" class="nav_menu_desktop w-nav-menu">
                ...
                <a href="/resources" aria-current="page" class="nav_menu_link light w-nav-link w--current">Resources</a>
              ...
              <div class="grid-4-columns">
                ...
                <div class="grid-column grid-column-footer grid-column-top">
                  ...
                  <ul role="list" class="footer-list w-list-unstyled">
                    ...
                    <li>
                      <a href="/resources" aria-current="page" class="footer-list-link w-inline-block w--current">
