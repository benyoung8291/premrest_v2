...
export default function ShawContractContent() {
  return (
    <RedesignLayout>
      <PageHero
        title="Maintain your carpet investment"
        subtitle="ShawContract have partnered with Premrest, a national service provider, specialising in floor cleaning, to deliver a maintenance plan that ensures the longevity, care and warranty of your ShawContract carpets."
      ...
      <ContentSection>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: spacing[12], alignItems: 'center' }}>
          <div>
            <img src="/images/Artboard1.png" alt="ShawContract x Premrest" style={{ maxWidth: '400px', width: '100%', marginBottom: spacing[6] }} />
            <p style={{ fontFamily: typography.fontFamily.body, fontSize: typography.fontSize['body-lg'], lineHeight: typography.lineHeight.relaxed, color: colors.charcoal.light }}>
              Premrest specialises in Encapsulation Cleaning Technology, ideal for commercial carpets. Using an eco-friendly cleaning agent, this system encapsulates and crystallises soils, spills, oils and bacteria in the carpet fibres, allowing for easy removal with routine vacuuming.
            </p>
            <p style={{ fontFamily: typography.fontFamily.body, fontSize: typography.fontSize['body-md'], lineHeight: typography.lineHeight.relaxed, color: colors.charcoal.light, marginTop: spacing[4] }}>
              Premrest Encapsulation features AFT (Active Film Technology) to help block oily binders that cause rapid resoiling, protecting your carpet. This process is both effective and sustainable, using up to <strong>76% less water</strong> and leaving carpets dry within minutes, ready for immediate use.
            </p>
            <p style={{ fontFamily: typography.fontFamily.body, fontSize: typography.fontSize['body-md'], lineHeight: typography.lineHeight.relaxed, color: colors.charcoal.light, marginTop: spacing[4] }}>
          ...
          <div style={{ borderRadius: borderRadius.lg, overflow: 'hidden' }}>
            <img src="/images/shawcontract_blob.webp" alt="People inside a common workspace" style={{ width: '100%', height: '500px', objectFit: 'cover', display: 'block' }} />
          </div>
        </div>
