...
export default function Page() {
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `@media (max-width:767px) and (min-width:480px) {html.w-mod-js:not(.w-mod-ix) [data-w-id="b5d019a4-e1ff-36f4-2b9d-b8d70fbc800e"] {-webkit-transform:translate3d(5px, 0px, 0px) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(5px, 0px, 0px) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(5px, 0px, 0px) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(5px, 0px, 0px) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform-style:preserve-3d;}}@media (max-width:479px) {html.w-mod-js:not(.w-mod-ix) [data-w-id="b5d019a4-e1ff-36f4-2b9d-b8d70fbc800e"] {-webkit-transform:translate3d(5px, 0px, 0px) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(5px, 0px, 0px) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(5px, 0px, 0px) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(5px, 0px, 0px) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform-style:preserve-3d;}}
              ...
              <div class="grid-2-columns">
                <div id="w-node-_97c7159a-ae20-3bc9-6d2d-67aaa472df89-cf92de7c" class="hero_content">
                  ...
                  <div id="w-node-_97c7159a-ae20-3bc9-6d2d-67aaa472df96-cf92de7c">
                    <a href="contact.html" data-w-id="97c7159a-ae20-3bc9-6d2d-67aaa472df97" style="opacity:0" class="button-4 is-tertiary w-button">Let&#x27;s chat</a>
                  </div>
                </div>
                <div id="w-node-_97c7159a-ae20-3bc9-6d2d-67aaa472df99-cf92de7c" class="home-hero-image-block">
                  <div class="column-image-block"><img sizes="100vw" srcset="/images/Premrest_Hero_Blob-p-500.webp 500w, /images/Premrest_Hero_Blob-p-800.webp 800w, /images/Premrest_Hero_Blob-p-1080.webp 1080w, /images/Premrest_Hero_Blob-p-1600.webp 1600w, /images/Premrest_Hero_Blob.webp 2000w" alt="people inside a common workspace" src="/images/Premrest_Hero_Blob.webp" loading="lazy" class="section-image section-image-right"><img loading="lazy" src="/images/Premrest_Lines_Green.svg" alt="green lines" class="home-hero-image-lines"><img loading="lazy" src="/images/Premrest_Skyline_Tan.svg" alt="tan skyline" class="home-hero-image-skyline"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container-xlarge">
            <div class="grid-wrapper">
              ...
              <div class="grid-6-columns">
                ...
                <div class="grid-column weworkwith-columns">
                  <a href="builders-developers.html" class="weworkwith-links w-inline-block"><img src="/images/drawing.png" loading="lazy" alt="" class="weworkwith-icons">
        ...
        <div class="padding-global padding-section-large">
          <div class="container-large">
            <div class="grid_wrapper">
              <div class="grid-2-columns">
                <div class="grid-column">
                  <div id="w-node-d9eef1ef-9d82-d4c9-72cd-53cfaced71bb-cf92de7c" class="column-image-block"><img src="/images/Premrest_Home_Problem_Blob.webp" loading="lazy" alt="" class="section-image"></div>
                </div>
                <div class="grid-column"><img src="/images/Premrest_DirtyShoe_Charcoal.svg" loading="lazy" width="Auto" height="200" alt="" class="home-problem-dirtyshoe">
                  ...
                  <a id="w-node-_8b8d4ea9-b977-2166-6fe2-6c9cee22610a-cf92de7c" href="contact.html" class="button w-button">Let&#x27;s chat</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container-large">
            <div class="grid-wrapper">
              ...
              <div id="w-node-_6f7909af-f2f6-3601-9be6-a63888f87905-cf92de7c" class="grid-3-columns grid-services">
                <a data-w-id="1c28cfa2-ccbc-392b-0422-36cc08322a26" style="opacity:0" href="cleaning.html" class="services-links w-inline-block">
                  <div class="grid-column">
                    ...
                    <div class="services-cards">
                      <div class="services-images">
                        <div class="services-overlay"></div><img src="/images/DSC03156.webp" loading="lazy" alt="" height="Auto" class="services-image">
                      </div>
                    </div>
                  </div>
                </a>
                <a data-w-id="8adb182d-0017-8337-6251-914fb1e3221c" style="opacity:0" href="installs.html" class="services-links w-inline-block">
                  <div class="grid-column">
                    ...
                    <div class="services-cards">
                      <div class="services-images">
                        <div class="services-overlay"></div><img src="/images/JLL_Melbourne_HighRes-40.webp" loading="lazy" alt="" height="Auto" class="services-image">
                      </div>
                    </div>
                  </div>
                </a>
                <a data-w-id="0d677895-d8e1-3d76-4fc0-9c2815e5ff23" style="opacity:0" href="special-projects.html" class="services-links w-inline-block">
                  <div class="grid-column">
                    ...
                    <div class="services-cards">
                      <div class="services-images">
                        <div class="services-overlay"></div><img src="/images/office-tour-kraft-heinz-1000x677-2020-Kitchen-2.webp" loading="lazy" sizes="100vw" height="Auto" alt="" srcset="/images/office-tour-kraft-heinz-1000x677-2020-Kitchen-2-p-500.webp 500w, /images/office-tour-kraft-heinz-1000x677-2020-Kitchen-2-p-800.webp 800w, /images/office-tour-kraft-heinz-1000x677-2020-Kitchen-2.webp 1000w" class="services-image">
                      </div>
                    </div>
                  </div>
                </a>
            ...
            <div class="grid-column padding-medium-top">
              <a id="w-node-f4ac1174-20cf-49e2-1052-f0db018f3a88-cf92de7c" href="contact.html" class="button w-button">Let&#x27;s chat</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="grid-wrapper resources-grid-wrapper">
              <div class="grid-2-columns-ltf">
                <div class="grid-column"><img src="/images/67a54d0fe733570a899a1d4b_LetsTalkFacilities_Logo2.svg" loading="lazy" alt="" class="letstalkfacilities-section-logo">
                  ...
                  <a href="lets-talk-facilities.html" class="button is-secondary is-inverse podcast-home-button w-button">View podcast</a>
                </div>
          ...
          <div class="container-large">
            <div class="grid-wrapper">
              <div id="w-node-fce61bbe-6568-c525-c7f3-039ad349bcec-cf92de7c" class="grid-column grid-column-1">
                ...
                <a id="w-node-fce61bbe-6568-c525-c7f3-039ad349bcef-cf92de7c" href="contact.html" class="button home-final-button w-button">Let&#x27;s chat</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="grid_wrapper">
              <div class="grid-4-columns">
                <div id="w-node-_22174fed-6f0e-2c64-aeba-cd40839aef1e-839aef19" class="grid-column grid-column-footer grid-column-top">
                  <a href="index.html" aria-current="page" class="footer_logo_link w-inline-block w--current"><img src="/images/Premrest_Tagline_Charcoal-Orange.svg" loading="lazy" alt="" class="footer_logo"></a>
